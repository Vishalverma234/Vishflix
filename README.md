...
🔗 **Live Demo:** https://vishalverma234.github.io/Netflix-Clone/
...
|-----------|---------------|
| ![Home](screenshots/home.png) | ![Movie](screenshots/modal.png) |
...
```bash
git clone https://github.com/Vishalverma234/Netflix-Clone.git
```
